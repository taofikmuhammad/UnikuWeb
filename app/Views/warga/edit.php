      ...
      <div class="container-fluid">
        <div class="row justify-content-md-left">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('warga/update/' . $detail_warga['nik']  ); ?>" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group">
                                <label for="">NIK</label>
                                <input value="<?=$detail_warga['nik']?>" type="number" name="nik" readonly class="form-control" placeholder="NIK" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=$detail->nama_lengkap?>" type="text" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=$detail->tempat_lahir?>" type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=$detail->tanggal_lahir?>" type="date" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=$detail->warganegara?>" type="text" maxlenght="3" name="warganegara" class="form-control" placeholder="Warga Negara" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Golongan Darah</label>
                                <input value="<?=$detail->golongan_darah?>" type="text" maxlenght="3" name="golongan_darah" class="form-control" placeholder="Golongan Darah" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Agama</label>
                                <input value="<?=$detail->agama?>" type="text" maxlenght="15" name="agama" class="form-control" placeholder="Agama" required="required">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="no_rt" class="form-control" required>
                                    ...
                                    <?php foreach ($rt as $x) : ?>
                                        <option value="<?= $x->no_rt ?>" <?= $detail->no_rt == $x->no_rt ? 'selected' : ''; ?> ><?= $x->no_rt.'-'.$x->nama_ketua ?></option>
                                    <?php endforeach ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_kecamatan" class="form-control" required>
                                    ...
                                    <?php foreach ($kecamatan as $x) : ?>
                                        <option value="<?= $x->id_kecamatan ?>" <?= $detail->id_kecamatan == $x->id_kecamatan ? 'selected' : ''; ?> ><?= $x->nama_kecamatan ?></option>
                                    <?php endforeach ?>
                                </select>
